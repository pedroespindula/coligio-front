...
const Disciplines = () => {
        ...
        return (
            <>
                ...
                <Container>
                    ...
                    {
                        isNewActivitie ? (
                            <Modal onClose={() => setNewActivitie(false)}>
                                <RegisterActivitie />
                            </Modal>
                        ) : null
                    }
    ...
    const [isNewActivitie, setNewActivitie] = useState(false);

    return (
        cargo === 'professor' ? <DisciplinesTeacher /> : <DisciplinesStudent />
    );
};
